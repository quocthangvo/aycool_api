...
public interface IOrderService {
    ...
    Float getTotalRevenueByTimeRange(OrderStatus status, LocalDateTime startDate, LocalDateTime endDate);

    List<Float> getTotalRevenueByWeek(OrderStatus status, LocalDateTime startDate, LocalDateTime endDate);

    List<Float> getTotalRevenueByMonth(OrderStatus status, LocalDateTime startDate, LocalDateTime endDate);

    List<Float> getTotalRevenueByQuarter(OrderStatus status, LocalDateTime startDate, LocalDateTime endDate);

    List<Float> getTotalRevenueByYear(OrderStatus status);
}
